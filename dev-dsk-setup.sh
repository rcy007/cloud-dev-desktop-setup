...
echo -e "2 = Just Python [Installs Pyenv, Miniconda-Latest, PIP, Python 3.13+, Jupyter Notebook Extensions and AWS-CLI] \n"
...
echo "Pyenv Installation Complete! Initiating env and python...\n\n"
